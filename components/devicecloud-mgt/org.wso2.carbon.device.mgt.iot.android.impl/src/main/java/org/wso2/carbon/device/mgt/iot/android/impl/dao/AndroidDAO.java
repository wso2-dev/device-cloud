...
package org.wso2.carbon.device.mgt.iot.android.impl.dao;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.device.mgt.iot.android.constants.AndroidConstants;
import org.wso2.carbon.device.mgt.iot.android.impl.dao.impl.AndroidDAOImpl;
...
public class AndroidDAO extends IotDeviceManagementDAOFactory implements IotDeviceManagementDAOFactoryInterface {
    ...
    public static void initAndroidDAO() {
        dataSource = getDataSourceMap().get(AndroidConstants.DEVICE_TYPE);
    }

    @Override public IotDeviceDAO getIotDeviceDAO() {
        return new AndroidDAOImpl();
    }
