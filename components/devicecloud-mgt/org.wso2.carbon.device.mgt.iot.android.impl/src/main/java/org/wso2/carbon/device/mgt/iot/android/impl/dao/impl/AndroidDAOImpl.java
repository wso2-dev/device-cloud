...
package org.wso2.carbon.device.mgt.iot.android.impl.dao.impl;
 ...
 */
public class AndroidDAOImpl implements IotDeviceDAO{
	

	    private static final Log log = LogFactory.getLog(AndroidDAOImpl.class);
	    ...
	    public IotDevice getIotDevice(String iotDeviceId)
	        ...
	        try {
	            conn = AndroidDAO.getConnection();
	            String selectDBQuery =
						"SELECT ANDROID_DEVICE_ID, DEVICE_NAME" +
						" FROM ANDROID_DEVICE WHERE ANDROID_DEVICE_ID = ?";
	            ...
	            if (resultSet.next()) {
					...
					iotDevice.setIotDeviceName(resultSet.getString(
							AndroidConstants.DEVICE_PLUGIN_DEVICE_NAME));
	    ...
	    public boolean addIotDevice(IotDevice iotDevice)
	        ...
	        try {
	            ...
	            String createDBQuery =
						"INSERT INTO ANDROID_DEVICE(ANDROID_DEVICE_ID, DEVICE_NAME) VALUES (?, ?)";
	    ...
	    public boolean updateIotDevice(IotDevice iotDevice)
	        ...
	        try {
	            ...
	            String updateDBQuery =
						"UPDATE ANDROID_DEVICE SET  DEVICE_NAME = ? WHERE ANDROID_DEVICE_ID = ?";
	    ...
	    public boolean deleteIotDevice(String iotDeviceId)
	        ...
	        try {
	            ...
	            String deleteDBQuery =
						"DELETE FROM ANDROID_DEVICE WHERE ANDROID_DEVICE_ID = ?";
	    ...
	    public List<IotDevice> getAllIotDevices()
	        ...
	        try {
				...
				while (resultSet.next()) {
					iotDevice = new IotDevice();
					iotDevice.setIotDeviceId(resultSet.getString(AndroidConstants.DEVICE_PLUGIN_DEVICE_ID));
					iotDevice.setIotDeviceName(resultSet.getString(AndroidConstants.DEVICE_PLUGIN_DEVICE_NAME));
