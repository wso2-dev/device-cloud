...
import org.wso2.carbon.device.mgt.iot.devicecloud.config.datasource.DataSourceConfigAdapter;
...
public class IotDeviceManagementRepository {
    ...
    public Map<String, IotDataSourceConfig> getIotDataSourceConfigMap() {
        return iotDataSourceConfigMap;
    }

    public void setIotDataSourceConfigMap(Map<String, IotDataSourceConfig> iotDataSourceConfigMap) {
