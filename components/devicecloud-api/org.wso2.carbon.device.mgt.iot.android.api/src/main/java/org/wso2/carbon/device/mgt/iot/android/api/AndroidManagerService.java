...
public class AndroidManagerService {

	private static Log log = LogFactory.getLog(AndroidManagerService.class);
	...
	public boolean register(@QueryParam("deviceId") String deviceId,
		...
		deviceIdentifier.setType(AndroidConstants.DEVICE_TYPE);
		try {
			...
			device.setName(name);
			device.setType(AndroidConstants.DEVICE_TYPE);
